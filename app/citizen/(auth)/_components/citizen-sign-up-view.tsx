...
export default function CitizenSignUpView() {
                ...
                <div className="px-8 pb-6">
                    ...
                    <div className="mt-6 flex flex-col gap-4">
                        <Button
                            ...
                            <span className='text-white'>{socialLoading ? <span className="flex items-center flex-row justify-center gap-1"><Spinner /> Signing Up...</span> : "Sign up with Google"}</span>
                        </Button>
