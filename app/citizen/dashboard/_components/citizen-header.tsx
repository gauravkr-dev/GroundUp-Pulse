        ...
        <div className={`fixed top-0 left-0 z-20 w-full transition-all duration-300 backdrop-blur-sm ${scrolled ? 'border-b' : 'border-b-0'}`}>
            <div className="flex flex-row justify-between items-center px-4 md:px-12 my-2">
                ...
                <div className='flex flex-row items-center gap-4 md:gap-8'>
                    <div className='flex flex-row items-center gap-4 text-sm md:text-base '>
                        {isMobile ? (
                            <Link href="/citizen/dashboard/achievements" className="rounded-full flex items-center justify-center p-1.5 size-8  cursor-pointer bg-white-500 text-black-500 border border hover:bg-muted hover:text-foreground">
                                <StarIcon className="text-yellow-500" />
                            </Link>
                        ) : (
                            <Link href="/citizen/dashboard/achievements" className="">
